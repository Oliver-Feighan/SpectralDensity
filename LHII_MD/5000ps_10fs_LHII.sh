#!/bin/bash
#SBATCH --job-name=5000ps_10fs_LHII
#SBATCH --output=5000ps_10fs_LHII.out
#SBATCH --error=5000ps_10fs_LHII.err
...
export OUTPUT_NAME="5000ps_10fs_LHII"
export LENGTH=5000     # ps
